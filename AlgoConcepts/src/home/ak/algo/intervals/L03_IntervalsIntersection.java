 ...
 *
 */
public class L03_IntervalsIntersection {
	...
	public static void main(String[] args) {
		...
		Interval[] result = L03_IntervalsIntersection.merge(input1, input2);
		...
		result = L03_IntervalsIntersection.merge(input1, input2);
		System.out.print("Intervals Intersection: ");
		for (Interval interval : result)
			System.out.print("[" + interval.start + "," + interval.end + "] ");
	}
