...
public class TugOfWar {
	...
	// 1. in each iteration, either add or remove the current element from the
	// selected array
	// 2. check if we have already selected the requried number of elements, in
	// that case update solution
	// 3. check if have already reached the end of the array, in that case,
	// simply return
